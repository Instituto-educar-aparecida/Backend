...
Bem-vindo ao ecossistema de desenvolvimento do **Instituto Educar** backend. Este projeto utiliza **Docker** para garantir que todos os 10 desenvolvedores e a gestão trabalhem em um ambiente idêntico.

##  🛠️ Pré-requisitos
Você precisa apenas do **Docker** instalado:
- Instalar node.js
- Instalar o docker: [site oficial](https://docs.docker.com)
- Instalar biblioteca pg para interagir com o postgresSQL 
    - abrir terminal e digitar `npm install pg` (mais rápido) ou  buscar instalador

## 🏃 Como Iniciar
1. Clone o repositório: `git clone https://github.com/Instituto-educar-aparecida/Backend`
2. Tenha certeza de estar na pasta base do projeto, o seu explorador de soluções deve mostrar exatamente a mesma sequencia de pastas e arquivos da página Backend no git
    * Caso não esteja use o comando : `cd [ENDEREÇO-DA-PASTA]`
